...
import { toSplatSceneUrl } from "@/lib/data/splat-embed";
...
const copy = {
  ...
  en: {
    eyebrow: "Media · Studio Works",
    backToIndex: "Back to Media",
...
export function MediaDetail({ work }: { work: StudioWork }) {
  ...
  if (work.trainingPipeline)
    specs.push([t.pipelineLabel, work.trainingPipeline]);
  ...
  return (
    <main className="min-h-screen bg-[#050505] px-5 pb-24 pt-28 text-[#f7f4ed] sm:px-10 sm:pt-32 lg:px-16 lg:pt-36">
      ...
      <section className="mx-auto mt-10 max-w-6xl">
        <div className="overflow-hidden rounded-[2.25rem] border border-white/10 bg-black">
          <div className="aspect-[16/9] w-full bg-black">
            <SplatEmbed
              url={work.embedUrl}
              sourceUrl={toSplatSceneUrl(work.embedUrl)}
      ...
      <section className="mx-auto mt-16 max-w-6xl">
        ...
        <h1 className="mt-3 break-words text-5xl font-semibold leading-[0.96] tracking-[-0.06em] [overflow-wrap:anywhere] sm:text-7xl">
          {work.exhibition
